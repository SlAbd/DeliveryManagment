...
public class LivreureRepository {
    ...
    public void update(Livreur livreur) {
        ...
        Utilisateur existingUser = existingLivreur.getUtilisateur();
        if (existingUser != null && livreur.getUtilisateur() != null) {
            if (livreur.getUtilisateur().getNom() != null) {
                existingUser.setNom(livreur.getUtilisateur().getNom());
            }
            if (livreur.getUtilisateur().getPrenom() != null) {
                existingUser.setPrenom(livreur.getUtilisateur().getPrenom());
            }
            if (livreur.getUtilisateur().getEmail() != null) {
                existingUser.setEmail(livreur.getUtilisateur().getEmail());
            }
