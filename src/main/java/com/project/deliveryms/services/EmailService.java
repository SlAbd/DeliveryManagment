...
public class EmailService {
    ...
    private static final String GMAIL_EMAIL_FROM = "nassimataarabet2003@gmail.com";
    private static final String GMAIL_APP_PASSWORD = "dfxd glfa mwtk rugz"; // App Password généré
